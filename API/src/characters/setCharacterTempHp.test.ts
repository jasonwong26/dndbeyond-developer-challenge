...
describe("setCharacterTempHp()", () => {
  ...
  const input: Types.SetTempHpRequest = {
    value: 5,
    override: false
  };
  ...
  it("200", async () => {
    ...
    await setCharacterTempHp(service)(request, response, next);
  ...
  it("500", async () => {
    ...
    await setCharacterTempHp(null as unknown as DataService)(request, response, next);
