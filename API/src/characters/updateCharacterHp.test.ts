...
describe("updateCharacterHp()", () => {
  ...
  const input: Types.UpdateHpRequest = {
    type: "piercing",
    value: 5
  };
  ...
  it("200", async () => {
    ...
    await updateCharacterHp(service)(request, response, next);
  ...
  it("500", async () => {
    ...
    await updateCharacterHp(null as unknown as DataService)(request, response, next);
